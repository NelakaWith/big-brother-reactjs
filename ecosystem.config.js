module.exports = {
  ...
  FRONTEND_URL: process.env.FRONTEND_URL || "https://bigbro.nelakawithanage.com",
      },
      env_development: {
  ...
  FRONTEND_URL: process.env.FRONTEND_URL || "http://localhost:3000",
    ...
    },
    {
      ...
      env: {
        NODE_ENV: "production",
        PORT: 3006,
  NEXT_PUBLIC_BACKEND_URL: process.env.NEXT_PUBLIC_BACKEND_URL || "https://bigbro.nelakawithanage.com",
